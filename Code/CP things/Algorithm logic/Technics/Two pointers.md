...
**Bản chất**: 2 con trỏ đi ngược hướng, cùng hướng, di chuyển có, không có điều kiện. Trên cùng 1 mảng hoặc khác mảng, ... Để tối ưu hóa bài toán tìm kiếm xuống O(n)
...
---
# Mục lục
1. [[#I. Các dạng phổ biến]]
	1. [[#1. Gộp tập]]
	2. [[#2. Hai con trỏ chạy ngược chiều]]
	3. [[#3. Hai con trỏ chạy cùng chiều]]
	4. [[#4.]]
